...
export const VIEW_COMPONENTS = ["Loader","Progress","LiveValue","AreaChart","BarChart","PieChart","LineChart","Metric","Alert","Badge"] as const;
export const ACTION_COMPONENTS = ["LiveAction","ActionButton","ActionCheckbox","ActionSelect","ActionTextarea","ActionInput"] as const;
