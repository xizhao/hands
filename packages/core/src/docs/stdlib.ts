...
export const STDLIB_COMPONENTS = {
  ...
  Metric: {
    category: "view",
    description:
      "KPI display for showing a single metric value with optional label and change indicator. Perfect for dashboards. Can consume data from parent LiveValue context or use direct value prop.",
    keywords: ["metric", "kpi", "number", "stat", "dashboard", "counter", "value", "indicator"],
    example:
