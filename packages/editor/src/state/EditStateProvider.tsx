...
import { type EditState, EditStateContext, EditStateManager } from "./EditStateManager";
...
export function EditStateProvider({ children, containerRef }: EditStateProviderProps) {
