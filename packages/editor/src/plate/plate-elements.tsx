...
export function ParagraphElement({ className, children, ...props }: PlateElementProps) {
  return (
    <PlateElement
      as="p"
      className={cn('m-0 py-1 text-base leading-7', className)}
      {...props}
    >
      {children}
    </PlateElement>
...
export function H1Element({ className, children, ...props }: PlateElementProps) {
  return (
    <PlateElement
      as="h1"
      className={cn(
        'mt-6 mb-2 text-3xl font-bold tracking-tight',
        className
      )}
      {...props}
    >
...
export function BlockquoteElement({ className, children, ...props }: PlateElementProps) {
  return (
    <PlateElement
      as="blockquote"
      className={cn(
        'my-2 border-l-2 border-gray-600 pl-4 italic text-gray-400',
        className
      )}
      {...props}
    >
