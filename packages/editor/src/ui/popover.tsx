...
const popoverVariants = cva(
  cn(
    'group/popover',
    'z-50 max-w-[calc(100vw-24px)] animate-popover overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-floating outline-hidden'
  ),
  {
    defaultVariants: {
      variant: 'default',
