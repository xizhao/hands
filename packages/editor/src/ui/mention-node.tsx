        ...
        <InlineComboboxContent variant="mention">
          ...
          <DocumentComboboxGroup
            ...
            onDocumentSelect={(document) => {
              editor.tf.insertNodes<EditorMentionElement>({
                key: `/${document.id}`,
                children: [{ text: '' }],
      ...
      {allDocuments.map((document) => (
        ...
        >
          <span className="mr-2 size-5">
            {document.icon ?? <FileText className="size-5" />}
          </span>
            ...
            <TooltipTrigger contentEditable={false}>
              ...
              >
                ...
                <span className="relative mr-3 inline-block">
                  {element.icon}
                  <ArrowSquareOut className="-right-3 absolute bottom-0 size-3.5" weight="bold" />
                </span>
...
function MentionHoverCardContent(props: { element: EditorMentionElement }) {
  ...
  useEffect(() => {
    ...
    if (
      ...
      editor.tf.setNodes<EditorMentionElement>(
        {
