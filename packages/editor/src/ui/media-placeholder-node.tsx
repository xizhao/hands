...
import { FileArrowUp, FilmStrip, Image, Waveform } from "@phosphor-icons/react";
...
function MediaPlaceholderPopover({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [uploadedFile, element.id, size, editor.api.findPath, editor, element, mediaType]);
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [progress, isUploading, uploadingFile, setIsUploading, setProgresses]);
