...
export function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn(
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 z-50 min-w-32 overflow-hidden rounded-lg border border-border/50 bg-popover p-1 text-popover-foreground shadow-floating data-[state=closed]:animate-out data-[state=open]:animate-in",
        className,
      )}
      {...props}
    />
...
export function DropdownMenuContent({
  ...
  const content = (
    <DropdownMenuPrimitive.Content
      className={cn(
        "no-focus-ring z-50 min-w-32 max-w-[100vw] overflow-hidden rounded-lg border border-border/50 bg-popover p-0 text-popover-foreground text-sm shadow-floating",
