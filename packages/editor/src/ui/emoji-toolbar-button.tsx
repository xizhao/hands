...
> = {
  ...
  custom: {
    outline: <Star className="size-full" />,
    solid: <Star className="size-full" weight="fill" />,
  },

  flags: {
    outline: <Flag className="size-full" />,
    solid: <Flag className="size-full" weight="fill" />,
  },

  foods: {
    outline: <AppleLogo className="size-full" />,
    solid: <AppleLogo className="size-full" weight="fill" />,
  },

  frequent: {
    outline: <Clock className="size-full" />,
    solid: <Clock className="size-full" weight="fill" />,
  },

  nature: {
    outline: <Leaf className="size-full" />,
    solid: <Leaf className="size-full" weight="fill" />,
  },

  objects: {
    outline: <Lightbulb className="size-full" />,
    solid: <Lightbulb className="size-full" weight="fill" />,
  },

  people: {
    outline: <Smiley className="size-full" />,
    solid: <Smiley className="size-full" weight="fill" />,
  },

  places: {
    outline: <Compass className="size-full" />,
    solid: <Compass className="size-full" weight="fill" />,
  },

  symbols: {
    outline: <MusicNote className="size-full" />,
    solid: <MusicNote className="size-full" weight="fill" />,
  },
};

const emojiSearchIcons = {
  delete: <X className="size-4 text-current" />,
  loupe: <MagnifyingGlass className="size-4 text-current" />,
};
