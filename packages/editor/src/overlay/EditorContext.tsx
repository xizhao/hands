...
export function useEditorSelection() {
  ...
  return {
    ...
    select: (nodeId: string, additive?: boolean) => dispatch({ type: "SELECT", nodeId, additive }),
    selectMany: (nodeIds: string[]) => dispatch({ type: "SELECT_MANY", nodeIds }),
    selectRange: (fromId: string, toId: string, allNodeIds: string[]) =>
      dispatch({ type: "SELECT_RANGE", fromId, toId, allNodeIds }),
    deselect: (nodeId: string) => dispatch({ type: "DESELECT", nodeId }),
...
export function useEditorHover() {
  ...
  return {
    ...
    setHover: (nodeId: string | null) => dispatch({ type: "SET_HOVER", nodeId }),
  };
}
...
export function useEditorEditing() {
  ...
  return {
    ...
    startEditing: (nodeId: string) => dispatch({ type: "START_EDITING", nodeId }),
...
export function useSlashMenu() {
  ...
  return {
    ...
    updateFilter: (filter: string) => dispatch({ type: "UPDATE_SLASH_FILTER", filter }),
    updateHighlight: (index: number) => dispatch({ type: "UPDATE_SLASH_HIGHLIGHT", index }),
    close: () => dispatch({ type: "CLOSE_SLASH_MENU" }),
  };
}
...
export function useEditorHistory() {
  ...
  return {
    ...
    push: (entry: HistoryEntry) => dispatch({ type: "PUSH_HISTORY", entry }),
...
export function useEditorClipboard() {
  ...
  return {
    ...
    clearClipboard: () => dispatch({ type: "CLEAR_CLIPBOARD" }),
  };
}
