/**
 * Sources - Table Containers with Optional Subscriptions
 *
 ...
 * ```
 */
export function defineSource(config: SourceDefinition): SourceDefinition {
  return config;
}
...
/**
 * A source discovered by the runtime
 */
