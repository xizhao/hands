...
import { getNodeById, getPathById, parseSourceWithLocations } from "../ast/oxc-parser";
import { applySurgicalMutation, type SurgicalMutation } from "../ast/surgical-mutations";
 ...
 */
function handleDelete(source: string, parseResult: ParseResult, nodeId: string): OperationResult {
  const { root } = parseResult;
